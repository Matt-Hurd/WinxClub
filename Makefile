...
# asm/nonmatching/ holds per-function pieces, not translation units.
ASM_SRCS := $(filter-out $(ASM_SUBDIR)/nonmatching/%,$(wildcard $(ASM_SUBDIR)/*.s $(ASM_SUBDIR)/*/*.s $(ASM_SUBDIR)/*/*/*.s))
