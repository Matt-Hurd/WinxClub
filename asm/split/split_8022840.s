...
sub_8022840 ;@ 0x08022840
	push {r3, r4, r5, r6, r7, lr}
	adds r5, r0, #0
	bl sub_80180BE
	ldr r6, _08022C28 ;@ =gUnknown_03003448
	movs r4, #0
_0802284C
	lsls r0, r4, #2
	adds r1, r0, r5
...
_08022910
	...
	movs r3, #9
	ldrsb r6, [r6, r3]
	ldr r7, _08022C2C ;@ =gUnknown_08050FF8
	lsls r3, r6, #2
	adds r3, r3, r6
	lsls r3, r3, #1
	mov ip, r3
...
_08022948
	...
	lsls r0, r0, #8
	bl sub_8040444
	ldr r5, _08022C30 ;@ =gUnknown_03003460
	ldr r0, [r5]
	bl sub_800B782
	movs r3, #0xa
	ldrsb r0, [r4, r3]
	...
	cmp r7, #0
	beq _080229AA
	ldr r0, _08022C34 ;@ =gUnknown_0300345C
	ldr r0, [r0]
	adds r0, #0xa0
	bl sub_8028C2E
_080229AA
...
sub_8022A24 ;@ 0x08022A24
	...
	add r0, sp, #0x48
	bl sub_80046F8
	ldr r1, _08022C2C ;@ =gUnknown_08050FF8
	movs r2, #0xc
	adds r1, #0x18
	add r0, sp, #0x3c
	bl __16__rt_memcpy
	ldr r0, _08022C2C ;@ =gUnknown_08050FF8
	add r3, sp, #0
	subs r0, #0xa
	ldrh r1, [r0]
	movs r4, #0
	...
	adds r2, r5, r0
	str r2, [sp, #0x58]
	ldr r0, _08022C38 ;@ =gUnknown_03003D30
	strb r4, [r2, #8]
	ldr r0, [r0]
	ldrb r1, [r0]
	ldr r2, [sp, #0x58]
	...
	strb r0, [r2, #0xb]
	str r4, [r5]
	ldr r0, _08022C3C ;@ =gUnknown_03003468
	str r4, [r5, #4]
	ldr r0, [r0]
	bl sub_80050FA
	add r6, sp, #4
	adds r0, r6, #0
	bl sub_8001A60
	ldr r0, _08022C40 ;@ =gUnknown_03003EA8
	add r1, pc, #0x1AC ;@ =_08022C44
	ldr r0, [r0]
	bl sub_8004FFC
	adds r3, r4, #0
	movs r2, #0
	...
	bl sub_802EF0A
	adds r1, r6, #0
	ldr r6, _08022C54 ;@ =gUnknown_03003450
	str r0, [sp, #4]
	ldr r0, [r6]
	bl sub_800D9E0
	ldr r0, _08022C58 ;@ =gUnknown_03003E98
	ldr r0, [r0]
	bl sub_800B08E
	movs r1, #0
	ldr r0, [r6]
...
_08022AF6
	...
	movs r6, #0
_08022B82
	ldr r0, _08022C28 ;@ =gUnknown_03003448
	ldr r0, [r0]
	bl sub_800116A
	lsls r1, r6, #2
	adds r2, r1, r5
...
_08022CA0
	...
	cmp r4, #2
	blo _08022C14
	ldr r0, _08022F6C ;@ =gUnknown_03003448
	ldr r0, [r0]
	bl sub_800116A
	lsls r1, r6, #2
	movs r2, #3
...
sub_8022D6E ;@ 0x08022D6E
	push {r4, r5, r6, r7, lr}
	sub sp, #0x1fc
	sub sp, #0x140
	add r4, sp, #0x14
	ldr r5, _08022F70 ;@ =sub_80143E0
	adds r1, r4, #0
	adds r1, #0xf8
	adds r0, r4, #0
	movs r2, #0x78
	...
	add r6, sp, #0x174
_08022DB6
	ldr r0, _08022F74 ;@ =gUnknown_03003444
	movs r2, #0
	ldr r0, [r0]
	adds r3, r2, #0
	ldr r1, [r0, #0x14]
...
_08022DD0
	...
	adds r0, r1, r0
	lsls r7, r0, #0x10
	ldr r0, _08022F78 ;@ =gUnknown_03003EA0
	lsrs r7, r7, #0x10
	ldr r0, [r0]
	bl sub_8000D5A
	ldr r0, [r0, #0x20]
...
_08022EA6
	...
	add r4, sp, #0x14
	adds r0, r4, r0
	ldr r1, _08022F7C ;@ =gUnknown_03003D30
	ldrb r2, [r0, #9]
	ldr r1, [r1]
	strb r2, [r1]
	ldrb r2, [r0, #0xa]
	...
	bl sub_80235E4
	ldrh r2, [r6, #0x1a]
	ldr r1, _08022F80 ;@ =gUnknown_080506E8
	ldrb r0, [r5]
	ldrb r5, [r1, r2]
	ldrh r2, [r6, #0x18]
	ldr r6, _08022F84 ;@ =gUnknown_0300345C
	cmp r0, #1
	ldrb r7, [r1, r2]
	beq _08022F04
	cmp r0, #2
...
sub_8022F8C ;@ 0x08022F8C
	push {r3, r4, r5, r6, r7, lr}
	adds r5, r0, #0
	ldr r0, _08023374 ;@ =gUnknown_0300345C
	movs r2, #0
	movs r1, #2
	ldr r0, [r0]
	bl sub_8028A7C
	...
	movs r0, #0xd5
	lsls r0, r0, #2
	ldr r6, _08023378 ;@ =gUnknown_03003448
	adds r1, r5, r0
	ldr r0, [r6]
	bl sub_8000DE6
	adds r1, r5, #0
...
_0802303A
	...
	movs r3, #9
	ldrsb r6, [r6, r3]
	ldr r7, _0802337C ;@ =gUnknown_08050FF8
	lsls r3, r6, #2
	adds r3, r3, r6
	lsls r3, r3, #1
	mov ip, r3
...
_08023072
	...
	lsls r0, r0, #8
	bl sub_8040444
	ldr r5, _08023380 ;@ =gUnknown_03003460
	ldr r0, [r5]
	bl sub_800B782
	movs r3, #0xa
	ldrsb r0, [r4, r3]
...
sub_80231B0 ;@ 0x080231B0
	...
	adds r4, r4, r2
	adds r0, r4, #0
	ldr r1, _08023384 ;@ =gUnknown_08051028
	bl __16__rt_memcpy
	ldr r0, _08023384 ;@ =gUnknown_08051028
	add r3, sp, #0
	subs r0, #0xc
	ldrh r1, [r0]
	strh r1, [r3, #0xc]
	...
	adds r3, r5, r0
	str r3, [sp, #0x30]
	ldr r0, _08023388 ;@ =gUnknown_03003D30
	strb r1, [r3, #8]
	ldr r0, [r0]
	ldrb r2, [r0]
	ldr r3, [sp, #0x30]
	...
	str r1, [r5]
	str r1, [r5, #4]
	add r0, pc, #0x174 ;@ =_0802338C
	bl sub_800EF60
	ldr r6, _08023380 ;@ =gUnknown_03003460
	ldr r0, [r6]
	cmp r0, #0
	beq _08023240
	bl sub_800B72A
...
_08023242
	...
	adds r0, r5, #0
	bl sub_8018C48
	ldr r0, _08023378 ;@ =gUnknown_03003448
	ldr r0, [r0]
	bl sub_800116A
	movs r1, #0xd
	lsls r1, r1, #6
...
_080233B0
	...
	cmp r4, #2
	blo _08023332
	ldr r0, _080235CC ;@ =gUnknown_03003448
	ldr r0, [r0]
	bl sub_800116A
	lsls r1, r6, #2
	movs r2, #7
...
sub_8023486 ;@ 0x08023486
	push {r4, r5, r6, r7, lr}
	sub sp, #0x1fc
	sub sp, #0x198
	add r6, sp, #4
	adds r1, r6, #0
	ldr r4, _080235D0 ;@ =sub_80143E0
	adds r1, #0xf8
	adds r7, r1, #0
	adds r0, r6, #0
	movs r2, #0x78
	...
	adds r5, r6, r0
_080234CE
	ldr r0, _080235D4 ;@ =gUnknown_03003444
	movs r1, #0
	ldr r0, [r0]
	ldr r2, [r0, #0x14]
	lsls r3, r2, #0x1c
...
_0802354C
	...
	cmp r0, #0
	beq _080234CE
	ldr r0, _080235D8 ;@ =gUnknown_03003D30
	ldrb r1, [r5, #9]
	ldr r0, [r0]
	strb r1, [r0]
	ldrb r1, [r5, #0xa]
	...
	strb r1, [r0, #2]
	bl sub_80235E4
	ldr r0, _080235DC ;@ =gUnknown_0300345C
	ldr r0, [r0]
	bl sub_8028C2E
	ldrb r0, [r4]
	cmp r0, #3
