...
_0801CF90
	...
	ldr r0, [r6, #0x2c]
	bl sub_80401E4
	ldr r0, _0801D110 ;@ =gPlayerPointer
	strb r4, [r0]
	bl sub_802383A
	ldr r0, _0801D114 ;@ =gPlayerEntity
	movs r3, #0x9b
	ldr r1, [r0]
	movs r0, #0x90
	ldrb r0, [r0, r1]
...
_0801D118
	...
	adds r0, r6, #0
	bl sub_80147FA
	ldr r0, _0801D500 ;@ =gPlayerEntity
	ldr r0, [r0]
	adds r0, #0xa0
	ldrb r0, [r0, #0xf]
	bl sub_80406A4
...
_0801D28A
	...
	bl sub_8018C48
_0801D294
	ldr r0, _0801D528 ;@ =gPlayerPointer
	movs r3, #0
	strb r3, [r0]
	bl sub_802383A
...
_0801D424
	...
	cmp r1, #0
	beq _0801D44E
	ldr r1, _0801D528 ;@ =gPlayerPointer
	strb r0, [r1]
	movs r0, #4
	strb r0, [r4, #0xc]
	ldr r0, [r6]
