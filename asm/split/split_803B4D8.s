...
IdentifyEeprom ;@ 0x0803B4D8
	...
	cmp r0, #4
	bne _0803B4F4
	ldr r1, _0803B4EC ;@ =eeprom
	ldr r0, _0803B4F0 ;@ =eeprom_list
	str r0, [r1]
	b _0803B510
	ALIGN
...
_0803B508
	ldr r1, _0803B518 ;@ =eeprom
	ldr r0, _0803B51C ;@ =eeprom_list
	str r0, [r1]
	movs r2, #1
_0803B510
	adds r0, r2, #0
